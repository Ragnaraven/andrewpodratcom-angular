    ...
    showcases: [
      ...
      },
      {
        ...
        textAbove:
          ...
          ' himself across the world, and with him comes death and destruction.<br/><br/>' +
    ...
    showcases: [
      {
        header: 'Backstory and Demo',
        textAbove:
          'I am a huge fan of city builders. CityBuilder is a side project I started to reinforce my understanding of multiplayer in UE4, as well as try out a new form of development. Various states and managers use UE4 replication to keep the game in sync. Like GhostGame, CityBuilder has taken on its own idea, and I have detailed plans for it that would make it a unique city builder complete with elements from games I have enjoyed in the past.',
        type: 'youtube',
        media: ['xU7SdGuVlNQ'],
      },
    ],
